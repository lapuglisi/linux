...
ifneq "$(KERNELVERSION)" "5.12.0"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/opt/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/opt/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
...
ifneq "$(NM)" "/opt/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/opt/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(AR)" "/opt/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-ar"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
